    ...
    <div className="flex max-w-6xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-20 mt-20 background-gradient">
        ...
        <div className="container mx-0 justify-center flex">
          <Link
          className="bg-stone-900 rounded-xl text-white hover:text-black font-medium px-4 py-3 sm:mt-10 mt-8 hover:bg-stone-100 transition mr-2"
          href="/signup"
        >
          Get Started
        </Link>
        <Link
          className="bg-transparent-600  hover:outline-0 rounded-xl text-white hover:text-black  font-medium px-4 py-3 sm:mt-10 mt-7 hover:bg-stone-100 transition"
          href="/login"
        >
          Login
        </Link>
